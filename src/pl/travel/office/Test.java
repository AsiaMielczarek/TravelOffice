...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Trip trip1 = new AbroadTrip(new Date(setDate("15.7.2019", "\\.")), new Date(setDate("28.7.2019", ".")), "Bali");
        ...
        Trip trip2 = new AbroadTrip(new Date(setDate("1-5-2019", "-")), new Date(setDate("14-2-2019", "-")), "Paris");
        ...
        Trip trip3 = new DomesticTrip(new Date(setDate("5/2/2019", "/")), new Date(setDate("14/2/2019", "/")), "Wrocław");
